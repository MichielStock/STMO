...
# ╔═╡ 90c40756-c1ff-4258-86a3-d746a85cafe4
md"""
## Random search
...
# ╔═╡ 7f7e9617-44ad-423f-beec-e0b574818a61
md"""
## Exercises
...
# ╔═╡ 82bf15a9-2bb0-4776-8bf0-c3ad9030ed04
md"""
**Assignments**
...
# ╔═╡ 6ead28bf-a2e3-43f7-8962-3f0f4e6ce4ca
"""
...
# ╔═╡ 8c434bb4-64ae-4232-bad0-36419d010ff2
"""
...
function random_search(f, (a, b); n=10)
    @assert a < b "Not a valid interval!"
   	missing # I believe in you!
end

# ╔═╡ 3780d246-6255-4189-a62e-ef08a13b4ed5
...
md"Defining some functions and useful variables."
...
# ╔═╡ e79100c1-6a18-4aab-9461-a117fa1922a1
ackley(1.0)  # scalar version

# ╔═╡ cf404673-5418-4352-9fc2-524fd0325444
ackley([1.0, -1.0])  # optional 2D version

# ╔═╡ 88db7212-49d1-4944-bdbd-f783b3119aba
plot(ackley, -pi, pi, label="Ackley", color=myblue, xlabel="x")
